...
export const gallery: GalleryContent = {
    sectionEyebrow: 'GALERÍA DE MARCAS Y SOLUCIONES',
    sectionTitle: 'Experiencia con tecnología de fabricantes líderes',
    sectionSubtitle:
        'Experiencia en el suministro y aplicación de productos de fabricantes líderes en instrumentación y control de procesos, garantizando soluciones confiables y eficientes para la industria.',
    brandsTitle: 'Marcas de referencia',
    productsTitle: 'Instrumentación seleccionada para las necesidades de cada proceso',
    brands: [
    ...
    products: [
        { title: 'Transmisor de presión', image: tpProductImage },
        ...
        { title: 'Computador de Flujo', image: spiritProductImage },
        { title: 'Medidor de caudal secundario', image: caudal2ProductImage },
        { title: 'Medidor másico', image: masicosProductImage },
        { title: 'Transmisor de presión', image: tp2ProductImage },
        { title: 'Computador de Flujo', image: cf3ProductImage },
        { title: 'Transmisor de presión', image: tp3ProductImage },
        { title: 'Transmisor de presión', image: tp4ProductImage },
